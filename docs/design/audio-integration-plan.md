...
v0.2.69 已接入 35 个正式 SFX 和 7 条当前 BGM，并把战斗必需音频、美术帧和动作节点加入开战前预热。战斗 SFX 会预解码成 Web Audio buffer；手机窄屏下，划动装饰音会跳过，非强制 SFX 会延后一帧播放，避免音频播放阻塞输入帧。正式文件放在：
...
- `docs/verification/v0268-hand-slot-render-jank.md`
- `docs/verification/v0269-webaudio-sfx-buffer.md`
