...
当前版本是 `v0.2.88 菜单版本修正`。

这一版修正主菜单里版本记录卡片仍显示旧版本的问题，长测记录也改为读取当前版本号，并更新缓存版本让手机拉取新脚本。

上一版 `v0.2.87 进战与受击节奏` 修复选关后进战慢的问题，开战不再等待整套资源预热。Boss 命中玩家后会留出一段恢复间隔，标准难度给玩家找回节奏，高难仍保留更快追击。
