...
当前版本是 `v0.2.87 进战与受击节奏`。

这一版修复选关后进战慢的问题，开战不再等待整套资源预热。Boss 命中玩家后会留出一段恢复间隔，标准难度给玩家找回节奏，高难仍保留更快追击。

上一版 `v0.2.86 全屏滑动出招` 把战斗输入改成战斗区任意位置滑动出招。方向动作不再要求瞄准某张卡，上划追身、左划破招、右划重刀、下划撤身先固定下来，卡牌暂时保留为构筑和状态展示。
